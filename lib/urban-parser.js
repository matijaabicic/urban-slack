    ...
    if(bodyString){
      ...
      switch(data.result_type)
      {
        case "exact":
        {
          ...
          {
              returnData.text = 'No definitions found. Use <code>/urban ?</code> for help.';
          }
        }
        break;
        ...
        default:
        {
          returnData.text = "No definitions found. Use <code>/urban ?</code> for help.";  // throw "Unexpected behaviour.";
        }
      }
    }
